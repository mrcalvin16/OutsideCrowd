...
export default function HostPage() {
 ...
 if (!isSignedIn) {
  return (
   <main className="flex min-h-screen pb-28 sm:pb-0 items-center justify-center bg-black text-white">
...
return (
  <main className="safe-x min-h-screen overflow-x-hidden bg-black pb-24 text-white md:pb-0">
   <div className="pointer-events-none fixed inset-0 overflow-hidden">
    <div className="absolute left-[-18%] top-[-12%] h-[360px] w-full sm:w-[360px] rounded-full bg-violet-600/20 blur-[110px] sm:h-[70vh] sm:h-[520px] sm:w-full sm:w-[520px]" />

    <div className="absolute right-[-20%] top-[18%] h-[420px] w-[calc(100vw-2rem)] sm:w-[420px] rounded-full bg-white/10 blur-[150px] sm:right-[-10%] sm:h-[72vh] sm:h-[600px] sm:w-[600px]" />

    <div className="absolute bottom-[-18%] left-[10%] h-[420px] w-[calc(100vw-2rem)] sm:w-[420px] rounded-full bg-violet-800/20 blur-[130px] sm:left-[30%] sm:h-[560px] sm:w-[560px]" />
   ...
   <section className="relative mx-auto max-w-7xl px-4 py-5 sm:px-6 sm:py-8 lg:px-8">
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
     <div className="absolute left-1/2 top-[120px] h-[70vh] sm:h-[520px] w-full sm:w-[520px] -translate-x-1/2 rounded-full border border-white/[0.05]" />
    ...
    <div className="relative mb-6 sm:mb-8 overflow-hidden rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-7 shadow-[0_0_120px_rgba(139,92,246,0.14)] backdrop-blur-2xl sm:p-10 lg:p-14">
     <div className="pointer-events-none absolute left-[-120px] top-[-120px] h-[340px] w-[340px] rounded-full bg-violet-500/20 blur-3xl" />
     <div className="pointer-events-none absolute right-[-140px] top-[20%] h-[420px] w-[calc(100vw-2rem)] sm:w-[420px] rounded-full bg-orange-500/20 blur-3xl" />
     ...
     <div className="relative z-10 flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:flex sm:flex-wrap lg:max-w-full sm:w-[520px] lg:justify-end">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-1 sm:grid-cols-1 lg:grid-cols-4">
    ...
    <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,.8fr)]">
     <section className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] p-4 sm:p-6 shadow-2xl backdrop-blur-xl">
      ...
      <div className="relative z-10">
       ...
       <h2 className="mt-2 text-2xl font-black tracking-[-0.04em] sm:tracking-tight">
        Ticket Momentum
       </h2>
       ...
       <div className="mt-5 grid grid-cols-1 sm:grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 sm:grid-cols-3 gap-3">
     ...
     <section className="relative overflow-hidden rounded-[2rem] border border-violet-300/15 bg-gradient-to-br from-violet-500/10 to-black p-4 sm:p-6 shadow-2xl backdrop-blur-xl">
      ...
      <div className="relative z-10 flex min-h-[190px] flex-col items-center justify-center text-center">
       <p className="text-[11px] sm:text-xs font-black uppercase tracking-[0.3em] text-violet-200/70">
        Live Pulse
       </p>
    ...
    <div className="mt-7 sm:mt-10 relative overflow-hidden rounded-[2.25rem] border border-violet-300/15 bg-gradient-to-r from-violet-500/10 via-white/[0.035] to-orange-500/10 p-7 shadow-[0_0_80px_rgba(139,92,246,0.12)] backdrop-blur-xl">
     ...
     <div className="relative z-10 flex flex-col gap-4 sm:p-6 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] sm:text-xs font-black text-white/75 sm:grid-cols-1 lg:grid-cols-4 lg:min-w-full sm:w-[520px]">
    ...
    <div className="mt-5 grid gap-4 md:grid-cols-1 sm:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <div className="mt-5 relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] p-4 sm:p-6 shadow-2xl backdrop-blur-xl">
     ...
     <div className="relative z-10 flex flex-col gap-4 sm:p-6 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="grid gap-2 sm:grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:grid-cols-4">
    ...
    <div className="mt-5 grid min-w-0 gap-5 xl:grid-cols-[minmax(0,1.7fr)_minmax(340px,.65fr)]">
     <section className="min-w-0 rounded-[1.75rem] border border-white/10 bg-zinc-950/70 p-4 shadow-2xl backdrop-blur-xl sm:rounded-[2rem] sm:p-5">
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
       ...
       <div className="flex flex-col gap-2 sm:flex-row">
        <Link
         href="/create-event"
         className="rounded-2xl border border-orange-300/25 bg-orange-500/10 px-4 min-h-11 py-3.5 sm:py-3 text-center text-sm font-black text-orange-100 transition hover:border-orange-300/50 hover:bg-orange-500/20"
        >
         New Event →
        </Link>
        ...
        <Link
         href="/host/analytics"
         className="rounded-2xl border border-violet-300/20 bg-violet-500/10 px-4 min-h-11 py-3.5 sm:py-3 text-center text-sm font-black text-violet-200 transition hover:border-orange-300/50 hover:bg-white/[0.06]"
        >
         Analytics →
        </Link>
       </div>
      ...
      {isLoading ? (
       <div className="max-w-full rounded-[1.5rem] sm:rounded-3xl border border-white/10 bg-white/[0.03] p-5 sm:p-8 text-zinc-400">
       ...
       <div className="relative overflow-hidden rounded-[2rem] border border-dashed border-orange-400/30 bg-gradient-to-br from-violet-500/15 to-orange-500/10 p-7 shadow-[0_0_70px_rgba(249,115,22,0.12)] sm:p-9">
        ...
        <div className="relative z-10">
         ...
         <h3 className="mt-3 text-2xl sm:text-3xl font-black tracking-[-0.04em] sm:tracking-tight">
          Your stage is ready.
         </h3>
         ...
         <Link
          href="/create-event"
          className="mt-6 inline-flex rounded-2xl bg-white px-5 min-h-11 py-3.5 sm:py-3 text-sm font-black text-black transition hover:bg-orange-200"
         >
          Create First Event →
         </Link>
        </div>
           ...
           <div className="grid min-w-0 gap-0 lg:grid-cols-[220px_minmax(0,1fr)]">
            <div className="relative h-36 overflow-hidden bg-gradient-to-br from-orange-500/25 via-zinc-900 to-black lg:h-full">
             {event.imageUrl ? (
              ...
              <div className="flex h-full items-center justify-center text-2xl sm:text-3xl sm:text-4xl">
               ✦
              </div>
             )}
             ...
             <div className="absolute bottom-4 left-4 right-4">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between rounded-2xl border border-white/10 bg-black/40 px-4 min-h-11 py-3.5 sm:py-3 backdrop-blur-xl">
               <div>
            ...
            <div className="min-w-0 p-4 sm:p-5">
             <div className="flex min-w-0 flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
              <div className="min-w-0">
               ...
               {event.isPromoted && (
                <div className="mb-3 rounded-2xl border border-orange-300/25 bg-violet-500/10 px-4 min-h-11 py-3.5 sm:py-3 text-[11px] sm:text-xs font-black uppercase tracking-[0.2em] text-violet-200">
               ...
               <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                 <h3 className="truncate text-2xl font-black tracking-[-0.04em] sm:tracking-tight">
                  {event.name || "Untitled Event"}
                 </h3>

                 <p className="mt-1 line-clamp-1 text-sm leading-6 text-zinc-400">
               ...
               <div className="mt-4">
                <div className="mb-2 flex justify-between gap-4 text-[11px] sm:text-xs text-zinc-500">
              ...
              <div className="w-full xl:max-w-[560px]">
               <div className="grid grid-cols-1 sm:grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 sm:grid-cols-3 gap-3">
               ...
               <button
                ...
                className="mt-3 w-full rounded-2xl border border-white/10 bg-white/[0.04] px-4 min-h-11 py-3.5 sm:py-3 text-[11px] sm:text-xs font-black uppercase tracking-[0.22em] text-white/70 transition hover:border-orange-300/40 hover:bg-violet-500/10 hover:text-white"
               >
                {expandedEventId === event._id ? "Hide Operations" : "Open Operations"}
               </button>

               {expandedEventId === event._id && (
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3 animate-in fade-in slide-in-from-top-2 duration-300">
                 ...
                 {event.isPromoted ? (
                  <button
                   ...
                   className="rounded-2xl border border-white/10 bg-black/40 px-4 py-4 text-center text-[11px] sm:text-xs font-bold text-zinc-200 transition hover:border-orange-300/40 hover:bg-violet-500/10 hover:text-white"
                  >
                   Unboost
                  </button>
                 ) : (
     ...
     <aside className="min-w-0 space-y-5">
      <section className="relative overflow-hidden rounded-[2.25rem] border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.025] p-4 sm:p-6 shadow-2xl backdrop-blur-xl">
       ...
       <h2 className="mt-3 text-2xl sm:text-3xl font-black tracking-[-0.04em] sm:tracking-tight">
        Organizer Pulse
       </h2>
       ...
       <div className="mt-6 rounded-[1.75rem] border border-white/10 bg-black/35 p-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between gap-4">
         <div>
          <p className="text-[11px] sm:text-xs font-black uppercase tracking-[0.28em] text-white/35">
           Command Signal
          </p>
          <p className="mt-2 text-2xl sm:text-3xl sm:text-4xl font-black tracking-[-0.05em]">
           {stats.sellThrough}%
          </p>
         </div>
        ...
        {recentActivity.length === 0 ? (
         ...
         recentActivity.map((event) => (
          <Link
           ...
           className="group min-h-[120px] sm:min-h-0 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between gap-4 rounded-2xl border border-white/10 bg-black/30 p-4 transition hover:border-orange-300/40 hover:bg-white/[0.05]"
          >
           <div className="min-w-0">
      ...
      <section className="rounded-[2rem] border border-orange-500/15 bg-orange-500/10 p-5 shadow-2xl backdrop-blur-xl">
       ...
       <Link
        href="/host/flyer-studio"
        className="mt-5 inline-flex rounded-full border border-orange-300/30 bg-black/30 px-5 min-h-11 py-3.5 sm:py-3 text-sm font-black text-orange-100 hover:bg-orange-500/20"
       >
        Create Promo Assets →
       </Link>
      </section>
   ...
   <div className="fixed inset-x-0 bottom-0 z-30 border-t border-white/10 bg-black/85 p-3 shadow-[0_-20px_60px_rgba(0,0,0,0.65)] backdrop-blur-2xl md:hidden">
    <div className="mx-auto grid max-w-[calc(100vw-2rem)] sm:max-w-md grid-cols-1 sm:grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 sm:grid-cols-3 gap-2">
...
function MissionMetric({
 ...
 return (
  <div className="group min-h-[120px] sm:min-h-0 relative overflow-hidden rounded-2xl border border-white/10 bg-black/35 p-4 transition hover:border-orange-300/30 hover:bg-white/[0.05]">
   ...
   <p className="text-[11px] sm:text-xs font-bold uppercase tracking-[0.24em] text-white/35">
    {label}
   </p>
...
function TopAction({ href, label }: { href: string; label: string }) {
 return (
  <Link
   href={href}
   className="group min-h-[120px] sm:min-h-0 relative overflow-hidden rounded-2xl border border-white/10 bg-black/25 px-5 py-4 text-center text-sm font-black uppercase tracking-wide text-white transition hover:-translate-y-0.5 hover:border-orange-300/40 hover:bg-white/10 hover:shadow-[0_0_35px_rgba(249,115,22,0.12)]"
  >
...
function Stat({
 ...
 return (
  <div className="group min-h-[120px] sm:min-h-0 relative min-w-0 overflow-hidden rounded-[1.35rem] border border-white/10 bg-white/[0.045] p-4 shadow-xl backdrop-blur-xl transition hover:border-orange-300/30 hover:bg-white/[0.065] sm:rounded-[1.75rem] sm:p-5">
   ...
   <p className="truncate text-[10px] font-bold uppercase tracking-[0.22em] text-zinc-500 sm:text-[11px] sm:text-xs">
    {title}
   </p>
   <p className="mt-3 truncate text-2xl font-black tracking-[-0.04em] sm:tracking-tight sm:mt-4 sm:text-2xl sm:text-3xl">
    {value}
   </p>
   <p className="mt-1 truncate text-[11px] sm:text-xs text-zinc-400 sm:mt-2 sm:text-sm">
    {detail}
   </p>
  </div>
 );
...
function MiniMetric({ label, value }: { label: string; value: string }) {
 return (
  <div className="group min-h-[120px] sm:min-h-0 relative min-w-0 overflow-hidden rounded-2xl border border-white/10 bg-black/30 p-4 transition hover:border-orange-300/30 hover:bg-white/[0.05]">
...
function Action({
 ...
 return (
  <Link
   ...
   className={
    featured
     ? "rounded-2xl border border-orange-300/30 bg-violet-500/15 px-4 py-4 text-center text-[11px] sm:text-xs font-black text-orange-100 transition hover:border-orange-300/60 hover:bg-orange-500/25"
     : "rounded-2xl border border-white/10 bg-black/40 px-4 py-4 text-center text-[11px] sm:text-xs font-bold text-zinc-200 transition hover:border-orange-300/40 hover:bg-violet-500/10 hover:text-white"
   }
  >
   {label}
  </Link>
...
function Status({
 ...
 return (
  <div className="mb-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between gap-4 rounded-2xl border border-white/10 bg-black/30 p-4">
   <span className="text-sm leading-6 text-zinc-400">{label}</span>
   <span
    className={
     good
...
function MobileNav({
 ...
 return (
  <Link
   ...
   className={
    primary
     ? "rounded-2xl bg-gradient-to-r from-orange-400 to-violet-500 px-3 py-3 text-center text-[11px] sm:text-xs font-black uppercase tracking-wide text-white shadow-[0_0_28px_rgba(249,115,22,0.22)]"
     : "rounded-2xl border border-white/10 bg-white/[0.05] px-3 py-3 text-center text-[11px] sm:text-xs font-black uppercase tracking-wide text-white/80 backdrop-blur-xl"
   }
  >
   {label}
  </Link>
...
function OperatingMode({
 ...
 return (
  <Link
   href={href}
   className="group min-h-[120px] sm:min-h-0 relative min-h-[250px] overflow-hidden rounded-[2.25rem] border border-white/10 bg-gradient-to-br from-white/[0.055] to-white/[0.025] p-5 shadow-2xl backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-orange-300/45 hover:bg-white/[0.075] hover:shadow-[0_0_70px_rgba(249,115,22,0.12)]"
  >
   ...
   <p className="mt-6 text-[11px] sm:text-xs font-black uppercase tracking-[0.28em] text-orange-300/70">
    {label}
   </p>

   <h3 className="mt-3 text-2xl font-black tracking-[-0.04em] sm:tracking-tight text-white">
    {title}
   </h3>
...
function RoadmapPill({ label, status }: { label: string; status: string }) {
 return (
  <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4 backdrop-blur-xl">
   <p className="text-[11px] sm:text-xs uppercase tracking-[0.25em] text-white/40">
    {label}
   </p>
...
function ChecklistItem({ label }: { label: string }) {
 return (
  <div className="group min-h-[120px] sm:min-h-0 rounded-2xl border border-white/10 bg-black/35 px-4 min-h-11 py-3.5 sm:py-3 text-sm font-black text-white/75 transition hover:border-orange-300/35 hover:bg-white/[0.06]">
